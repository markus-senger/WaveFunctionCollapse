...
public class NeighborDefinition006 : MonoBehaviour, IColorDefinition
{
    private List<string> possibleNeighbors = new List<string> { "aba", "aaa", "aba", "aaa" };
    ...
    {
        possibleNeighbors = new List<string> { "aba", "aaa", "aba", "aaa" };
